...
public class GalaxyGenerator {
    ...
    private static final Star ALPHA_CENTAURI_A = new Star("Alpha Centauri A", SpectralType.G, 2, LuminosityClass.MAIN_SEQUENCE, 1.1, 1.52, 5800);
    private static final Star ALPHA_CENTAURI_B = new Star("Alpha Centauri B", SpectralType.K, 2, LuminosityClass.MAIN_SEQUENCE, 0.91, 0.45, 4900);
    
    /*
     * TODO GalaxyGenerator constructor which takes parameters
     * for example:
     * - x/y/z dimension(s)
	...
	StarSystem alphaCentauri = new StarSystem("Alpha Centauri",
		new Coordinates(4, 0, 1), StarHierarchy.createBinaryPair(
