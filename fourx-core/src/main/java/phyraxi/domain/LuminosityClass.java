...
public enum LuminosityClass {
	...
	HYPERGIANT(Constants.HYPERGIANT_SYMBOL), SUPERGIANT(Constants.SUPERGIANT_SYMBOL), BRIGHT_GIANT(
			Constants.BRIGHT_GIANT_SYMBOL), GIANT(Constants.GIANT_SYMBOL), SUBGIANT(Constants.SUBGIANT_SYMBOL), MAIN_SEQUENCE(
			Constants.MAIN_SEQUENCE_SYMBOL), SUBDWARF(Constants.SUBDWARF_SYMBOL), WHITE_DWARF(
			Constants.WHITE_DWARF_SYMBOL);
